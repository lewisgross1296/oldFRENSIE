...
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<15,FloatType>::getGaussWeights() 
{
  ...
  static std::vector<FloatType> gauss_weights_15_pt_rule =
...
template<typename FloatType>  
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<15,FloatType>::initializeGaussWeights() 
{ 
...
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<15,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_weights_15_pt_rule =
...
template<typename FloatType> 
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<15,FloatType>::initializeKronrodWeights()
{
...
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<15,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_15_pt_rule =
...
template<typename FloatType>  
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<15,FloatType>::initializeKronrodAbscissae()
{
...
// Get the Gauss quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<21,FloatType>::getGaussWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the gauss weights
  static std::vector<FloatType> gauss_weights_21_pt_rule =
    initializeGaussWeights();
...
// Initialize the gauss weight array
template<typename FloatType>  
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<21,FloatType>::initializeGaussWeights()
{ 
...
// Get the Kronrod quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<21,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_weights_21_pt_rule =
    initializeKronrodWeights();
...
// Initialize the kronrod weight array
template<typename FloatType>  
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<21,FloatType>::initializeKronrodWeights()
{
...
// Get the Kronrod quadrature abscissae  
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<21,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_21_pt_rule =
    initializeKronrodAbscissae();
...
// Initialize the kronrod abscissae array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<21,FloatType>::initializeKronrodAbscissae()
{
...
// Get the Gauss quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<31,FloatType>::getGaussWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the gauss weights
  static std::vector<FloatType> gauss_weights_31_pt_rule =
    initializeGaussWeights();
...
// Initialize the gauss weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<31,FloatType>::initializeGaussWeights()
{ 
...
// Get the Kronrod quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<31,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_weights_31_pt_rule =
    initializeKronrodWeights();
...
// Initialize the kronrod weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<31,FloatType>::initializeKronrodWeights()
{
...
// Get the Kronrod quadrature abscissae  
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<31,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_31_pt_rule =
    initializeKronrodAbscissae();
...
// Initialize the kronrod abscissae array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<31,FloatType>::initializeKronrodAbscissae()
{
...
// Get the Gauss quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<41,FloatType>::getGaussWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the gauss weights
  static std::vector<FloatType> gauss_weights_41_pt_rule =
    initializeGaussWeights();
...
// Initialize the gauss weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<41,FloatType>::initializeGaussWeights()
{ 
  std::vector<FloatType> gauss_weights(10);
  guass_weights[0] = 0.017614007139152118311861962351853;
  guass_weights[1] = 0.040601429800386941331039952274932;
  guass_weights[2] = 0.062672048334109063569506535187042;
  guass_weights[3] = 0.083276741576704748724758143222046;
  guass_weights[4] = 0.101930119817240435036750135480350;
  guass_weights[5] = 0.118194531961518417312377377711382;
  guass_weights[6] = 0.131688638449176626898494499748163;
  guass_weights[7] = 0.142096109318382051329298325067165;
  guass_weights[8] = 0.149172986472603746787828737001969;
  guass_weights[9] = 0.152753387130725850698084331955098;
...
// Get the Kronrod quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<41,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_weights_41_pt_rule =
    initializeKronrodWeights();
...
// Initialize the kronrod weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<41,FloatType>::initializeKronrodWeights()
{
...
// Get the Kronrod quadrature abscissae  
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<41,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_41_pt_rule =
...
// Initialize the kronrod abscissae array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<41,FloatType>::initializeKronrodAbscissae()
{
...
// Get the Gauss quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<51,FloatType>::getGaussWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the gauss weights
  static std::vector<FloatType> gauss_weights_51_pt_rule =
    initializeGaussWeights();
...
// Initialize the gauss weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<51,FloatType>::initializeGaussWeights()
{ 
...
// Get the Kronrod quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<51,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
...
// Initialize the kronrod weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<51,FloatType>::initializeKronrodWeights()
{
...
// Get the Kronrod quadrature abscissae  
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<51,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_51_pt_rule =
    initializeKronrodAbscissae();
...
// Initialize the kronrod abscissae array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<51,FloatType>::initializeKronrodAbscissae()
{
...
// Get the Gauss quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<61,FloatType>::getGaussWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the gauss weights
  static std::vector<FloatType> gauss_weights_61_pt_rule =
    initializeGaussWeights();
...
// Initialize the gauss weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<61,FloatType>::initializeGaussWeights()
{ 
...
// Get the Kronrod quadrature weights 
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<61,FloatType>::getKronrodWeights()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_weights_61_pt_rule =
    initializeKronrodWeights();
...
// Initialize the kronrod weight array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<61,FloatType>::initializeKronrodWeights()
{
...
// Get the Kronrod quadrature abscissae  
template<typename FloatType>  
inline const std::vector<FloatType>& GaussKronrodQuadratureSetTraits<61,FloatType>::getKronrodAbscissae()
{
  // We use a static variable here to avoid the multiple definition errors
  // that would occur if we used a static class variable. This also provides
  // just-in-time initilization of the kronrod weights.
  static std::vector<FloatType> kronrod_abscissae_61_pt_rule =
    initializeKronrodAbscissae();
...
// Initialize the kronrod abscissae array
template<typename FloatType>
inline std::vector<FloatType> GaussKronrodQuadratureSetTraits<61,FloatType>::initializeKronrodAbscissae()
{
